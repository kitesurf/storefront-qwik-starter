	...
	return (
		<div class="min-h-screen bg-gray-50">
			<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
				{/* Product Header */}
				<div class="mb-8">
					<h1 class="text-4xl font-light text-gray-900 mb-4">{productSignal.value.name}</h1>
					<Breadcrumbs
						items={
				...
				<div class="grid lg:grid-cols-2 gap-x-12 gap-y-8">
					...
					<div class="space-y-6">
						...
						<div class="flex gap-4">
							<button
								class={{
									'flex-1 px-8 py-3 rounded-md font-medium text-white transition focus:outline-none focus:ring-2 focus:ring-offset-2':
										true,
						...
						<div class="border-t pt-6 space-y-4">
							...
							<div class="text-sm text-gray-500 space-y-2">
								...
								<p>
									Returns available within 30 days. See{' '}
									<a href="/returns" class="underline">
										returns page
									</a>{' '}
									for details.
								</p>
